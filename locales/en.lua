local Translations = {
    ...
    menu = {
        ...
        gungame = 'Gun Game',
        gungame_desc = 'Progress through weapons with each kill',
        lms_toggle = 'Last Man Standing',
        lms_toggle_desc = 'One life per player — eliminated on hit',
        enabled = 'Enabled',
        disabled = 'Disabled',
        ...
        select_score_limit = 'Set Score Limit',
        score_limit_input_label = 'Kills to win (0 = timer only)',
        current_score_limit = 'Current Limit',
        my_stats = 'My Stats',
        my_stats_desc = 'View your lifetime airsoft stats',
        career_stats_body = 'Kills: %{kills}\nDeaths: %{deaths}\nK/D: %{kd}\nMatches: %{matches}',
    },
    spectator = {
        entered = 'You are now spectating. Press [E] to leave early.',
        eliminated = 'You have been eliminated. Spectating until the match ends.',
    },
    inarena = {
    ...
    notifications = {
        ...
        match_ended_elimination = 'Match ended: all opponents are out.',
        lms_enabled = 'Last Man Standing enabled.',
        lms_disabled = 'Last Man Standing disabled.',
        score_limit_set = 'Score limit set to:',
        score_limit_disabled = 'Timer only',
        invalid_score_limit = 'Invalid score limit!',
        gungame_stage = 'Gun game tier %{stage}/%{total}',
        no_career_stats = 'No career stats yet — play a match first!',
    },
    leaderboard = {
        title = 'AIRSOFT ARENA',
        ...
        no_team = 'No Team',
        ffa = 'FFA',
        first_to_kills = 'First to %{limit} kills',
        mvp = 'MVP',
